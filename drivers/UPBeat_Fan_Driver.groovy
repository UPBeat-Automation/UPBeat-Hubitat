/*
 * Hubitat Driver: UPB Fan Switch
 * Description: Universal Powerline Bus Fan Switch Driver (On/Off only)
...
metadata {
    definition(name: "UPB Fan Switch", namespace: "UPBeat", author: "UPBeat Automation", importUrl: "") {
        capability "Switch"
